...
/**
 * Take that edits the name of the user.
 *
 * <p>The class is immutable and thread-safe.</p>
 *
 * @author Marcel Brou (broumarcel87@gmail.com)
 */
public final class TkEditUserName implements Take {
	 ...
	 */
	public TkEditUserName(final Database database) {
